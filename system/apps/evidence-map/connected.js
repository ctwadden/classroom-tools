(() => {
  ...
  function showView(view, focus = false) {
    ...
    state.view = view;
    syncLocation();
    $$('[data-field-link]').forEach(a => a.href = Core.fieldCaptureUrl(state.course));
  ...
  function renderOverview() {
    ...
    $('#connections').innerHTML = [
      ...
      ['iPad companion', 'Shared classroom connection', 'Use iPad assessment tools above. The selected course and approved rubric travel with the link; check the Google receipt in Saved & pending.', true],
